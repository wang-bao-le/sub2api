export default {
  ...
  payment: {
    ...
    rechargeHeroTitle: 'Top up your API balance',
    rechargeHeroDescription: 'Choose an amount, then pay using an available method.',
    orderSummary: 'Order summary',
    paymentConfirmationHint: 'Your balance updates automatically after payment is confirmed.',
