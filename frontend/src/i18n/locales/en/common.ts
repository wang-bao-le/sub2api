export default {
  common: {
    ...
    logoutConfirmMessage: 'You will need to sign in again to continue using this account. Are you sure you want to log out?',
  ...
  auth: {
    ...
    errors: {
      ...
      EMAIL_RESERVED: 'This email cannot be used right now.',
      ...
      REGISTRATION_DISABLED: 'Registration is temporarily disabled. Please contact the administrator.',
      ...
      CAPTCHA_PROVIDER_CONFLICT: 'The captcha service configuration conflicts. Please contact the administrator.',
      INVALID_RESET_TOKEN: 'The password reset link is invalid or expired. Please request a new one.',
      TOTP_INVALID_CODE: 'The authenticator code is incorrect. Please try again.',
