export default {
  ...
  auth: {
    ...
    passwordHint: '至少 8 个字符，且必须包含字母和数字',
    emailRequired: '请输入邮箱',
    invalidEmail: '请输入有效的邮箱地址',
    ...
    errors: {
      ...
      CAPTCHA_PROVIDER_CONFLICT: '验证码服务配置冲突，请联系管理员。',
      INVALID_RESET_TOKEN: '密码重置链接无效或已过期，请重新请求。',
      TOTP_INVALID_CODE: '身份验证器验证码错误，请重试。',
      TOTP_TOO_MANY_ATTEMPTS: '验证次数过多，请稍后再试。',
