    ...
    <div class="space-y-6">
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div>
          ...
          <p v-if="errors.email" id="register-email-error" class="input-error-text" role="alert">{{ errors.email }}</p>
        </div>
        ...
        <div>
          ...
          <p v-if="errors.confirmPassword" id="register-confirm-password-error" class="input-error-text" role="alert">
