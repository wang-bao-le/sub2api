<template>
  <div class="min-h-screen bg-gray-50 text-gray-950 dark:bg-dark-950 dark:text-white">
    ...
    <main class="mx-auto grid max-w-[1440px] gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[calc(220px+3cm)_minmax(0,1fr)_220px] lg:px-8">
      ...
      <section class="min-w-0">
        ...
        <article v-else-if="markdown" class="docs-article card px-6 py-8 sm:px-10 lg:px-12">
...
const groups: DocGroup[] = [
  { title: '开始使用', items: [{ slug: 'introduction', title: '简介' }, { slug: 'faq', title: '常见问题' }, { slug: 'dragon-code-guide', title: 'Dragon Code 使用指南' }] },
