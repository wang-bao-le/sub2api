...
const groups: DocGroup[] = [
  { title: '入门', footerTitle: '环境准备', footerItems: [{ slug: 'nodejs-environment', title: 'Node.js 环境安装指南' }, { slug: 'cc-switch-installation', title: 'CC Switch安装指南' }], items: [{ slug: 'quickstart', title: '快速开始' }] },
