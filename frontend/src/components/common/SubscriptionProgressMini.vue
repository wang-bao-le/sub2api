          ...
          >
            ...
            <div class="space-y-1.5">
              ...
              <div
                ...
                class="flex items-center gap-2 rounded-lg bg-gradient-to-r from-emerald-50 to-emerald-100 px-2.5 py-1.5 dark:from-emerald-900/20 dark:to-emerald-900/30"
              >
